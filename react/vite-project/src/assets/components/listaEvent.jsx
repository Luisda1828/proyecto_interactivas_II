        ...
        <div className="mb-3 rounded-2xl min-h-32  ring-white ml-[30%] relative ">
            ...
            <div className="absolute right-[127.5%] h-full flex  flex-col">
                <div className="relative flex justify-center " >
                    <div className=" absolute size-5 bg-white rounded-full top-[3.5rem] "></div>
                    <div className=" absolute  h-40 top-0   w-1  bg-white  rounded-3xl"></div>
            ...
            <div className="relative flex m-3">
                ...
                <button class=" text-white flex items-center">
                    <span className=" text-white mr-3 ml-0">Aplicaciones interactivas 2</span>
