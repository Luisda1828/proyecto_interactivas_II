...
function Login() {
    ...
    <div className="flex flex-col justify-center items-center m-auto p-8 w-[29rem] ">
      ...
      />
      <input
        className="my-3 text-center ring-2 ring-white rounded-full text-white bg-transparent w-full h-10 focus: outline-none"
      ...
      <a
        className=" flex justify-center items-center my-3 text-center ring-2 ring-white rounded-full text-white bg-transparent w-full h-10 focus: outline-none "
        href="index.html"
      >
        Iniciar sesión
      </a>
